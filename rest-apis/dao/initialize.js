...
const {hashPassword} = require('../controllers/passwords');
...
const createAdminCalendar = `INSERT INTO calendar (owner_id) VALUES((SELECT id FROM users WHERE email = '${adminEmail}'))`
