...
const createWishlistItemTable = 'CREATE TABLE IF NOT EXISTS wishlist_item (id INTEGER PRIMARY KEY, experience_id INTEGER, wishlist_id INTEGER, CONSTRAINT fk_wishlist_item FOREIGN KEY (experience_id) REFERENCES experiences(id) ON DELETE CASCADE, CONSTRAINT fk_wishlist FOREIGN KEY (wishlist_id) REFERENCES wishlists(id) ON DELETE CASCADE);';
